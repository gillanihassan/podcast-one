...
export default function AboutSection() {
  return (
    <section
      id="about-section"
      className="relative w-full min-h-screen bg-[#FDF4E3] font-sans flex flex-col items-center"
    >
      <div className="w-full max-w-[1980px] px-2 lg:px-12 flex-grow flex flex-col justify-center pb-24 lg:pb-32 pt-12 lg:pt-8 mt-4">
        {/* Main Text */}
        <div className="max-w-[1100px]">
          <h1 className="font-aeonik text-[28px] sm:text-[36px] md:text-[44px] lg:text-[52px] xl:text-[60px] font-medium leading-[110%] tracking-[-0.02em] text-[#350A32]">
        ...
        {/* Stats */}
        <div className="flex flex-wrap items-start gap-12 sm:gap-16 md:gap-24 lg:gap-32 xl:gap-30 mt-20 lg:mt-32 pt-10">
