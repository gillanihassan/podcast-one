...
export default function TestimonialSection() {
  ...
  return (
    <section className="bg-[#350A32] text-white py-24 sm:py-32 px-4 md:px-20 relative flex flex-col items-center justify-center w-full min-h-[500px]">

      {/* Left Arrow */}
      <button
        onClick={prevSlide}
        className="absolute left-4 sm:left-8 md:left-12 top-1/2 -translate-y-1/2 text-[#FDF4E3]/70 hover:text-[#FDF4E3] transition-colors"
      >
      ...
      <div className="flex flex-col items-center gap-12 md:gap-16 max-w-[800px] xl:max-w-[1000px] w-full text-center px-10 md:px-0">
        ...
        >
          <h2 className="font-aeonik font-medium text-[32px] sm:text-[35px] md:text-[42px] lg:text-[55px] xl:text-[60px] leading-[1.15] tracking-[-1%] text-[#FFFFFF]">
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 sm:right-8 md:right-12 top-1/2 -translate-y-1/2 text-[#FDF4E3]/70 hover:text-[#FDF4E3] transition-colors"
      >
